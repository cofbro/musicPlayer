...
class selectAdapter(val context: Context): RecyclerView.Adapter<selectAdapter.MyViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return mImgIds.size/3
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater
            .from(parent.context)
            .inflate(R.layout.activity_select_gallery_item,parent,false)
        return MyViewHolder(view)
    }
    class MyViewHolder(view: View): RecyclerView.ViewHolder(view){
        var letterview_top1_view = itemView.findViewById<ImageView>(R.id.imageView_top1)
        var letterview_top2_view = itemView.findViewById<ImageView>(R.id.imageView_top2)
        var letterview_top3_view = itemView.findViewById<ImageView>(R.id.imageView_top3)
        var letterview_top1 = itemView.findViewById<TextView>(R.id.show1)
        var letterview_top2 = itemView.findViewById<TextView>(R.id.show2)
        var letterview_top3 = itemView.findViewById<TextView>(R.id.show3)
    }
